...
import { lerp, clamp } from '../helpers/math';
import { constants } from '../helpers/gsap-store';
...
export default class Scroll {
  constructor() {
    ...
    this.dom = {
      container: document.querySelector('[data-virtual-scroll]')
    };
  ...
  startMove = () => {
    this.state.current = clamp(-300, 60, -300);
  }
