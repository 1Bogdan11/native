...
<div class="container section__wrapper article">
    ...
    <div class="diary-section diary-section--article">
        <div class="diary-section__head" data-scroll data-observe="fade">
            <div class="diary-section__part">
                <div class="diary-section__title"><?=Loc::getMessage('LJ_OTHER_NEWS')?></div>
            </div>
            <div class="diary-section__part"></div>
        </div>
        <?
        $GLOBALS['filterArticleDetailPage'] = ['!ID'=>$ElementID];
        ?>
        <?$APPLICATION->IncludeComponent(
            ...
            Array(
                ...
                "USE_PERMISSIONS" => $arParams["USE_PERMISSIONS"],
                "GROUP_PERMISSIONS" => $arParams["GROUP_PERMISSIONS"],
                "FILTER_NAME" => 'filterArticleDetailPage',
