...
$MESS['ORDER_FIELD_PERSONAL_PHONE_VALID'] = 'Неверный формат номера телефона!';
$MESS['ORDER_FIELD_PERSONAL_PHONE_CONFIRM'] = 'Номер телефона не подтвержден!';
$MESS['ITS_AGENCY_COMPONENT_PHONE_AUTH_ERROR_USER_BANNED'] = 'Пользователь заблокирован!';
