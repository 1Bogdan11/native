...
class SmsAeroSdkV2
{
    public const URL_SMSAERO_API = 'https://gate.smsaero.ru/v2';
    private string $email = ''; //Ваш логин|email
    private string $api_key = ''; //Ваш api_key можно получить по адресу https://smsaero.ru/cabinet/settings/apikey/
     ...
     * @return mixed
     */
    private function curl_post($url, array $post = [], array $options = [])
    {
        $defaults = [
            CURLOPT_POST => 1,
            CURLOPT_HEADER => 0,
     ...
     * @return array
     */
    public function send($number, $text, $sign = false, $dateSend = null, $callbackUrl = null)
    {
