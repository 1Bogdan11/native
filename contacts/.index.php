...
<div class="aside-tabs__links media-max--tab">
    ...
    <button class="aside-tabs__link is-active" data-tab="contacts">Контакты</button>
    <button class="aside-tabs__link" data-tab="requisites">Реквизиты</button>
</div>
<?php
        ...
        <div class="aside-tabs aside-tabs--partial">
            <div class="aside-tabs__area">
                <div class="aside-tabs__content is-active" data-tab-content="contacts">
                    <a href="<?=SITE_DIR?>shops/" class="link-circle">Адреса магазинов</a>
                ...
                <div class="aside-tabs__content" data-tab-content="requisites">
                    <div class="contacts__head">
                        <div class="contacts__head">
                            <div class="contacts__head_title">Реквизиты</div>
